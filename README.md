...
# ML model for critical property prediction

This repository contains the sample scripts for the ML models for critical property predictions. 
...
Details on our models can be found in the manuscript, "Predicting Critical Properties of Fluids Using Multi-Task Machine Learning"
...
3. Download the `CritProp_ML_model_fiiles_with_abraham_feat.zip` file from https://zenodo.org/record/7804143, unzip it, and move it under `chemprop/crit_prop_model_files/`
...
1. Download the `CritProp_ML_model_fiiles_without_additional_feat.zip` file from https://zenodo.org/record/7804143, unzip it, and move it under `chemprop/crit_prop_model_files/`
